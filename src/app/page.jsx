...
{/* Image */}
  ...
  <div className="h-1/2  lg:h-full lg:w-1/2  flex flex-col gap-10 items-center justify-center  ">
    {/* TITLE */}
    <h1 className=" md:text-6xl text-4xl font-bold">Crafting Digital Experiences, one Dart at a Time.</h1>
    {/* DESC */}
    <p className=" md:text-xl">Welcome to my digital space, where innovations and crativity converge. 
